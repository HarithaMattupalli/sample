                    ...
                    <div className="col-sm-6 col-md-6 mt-4  " key={index}>
                        <div className="card">
                            ...
                            <div className="card-body text-center">
                                <h4 className="card-header bg-dark text-white">{values.features.Brand}</h4> 
                                <Link to={{pathname:'/Details',data:{id:index}}} className="btn btn-success mt-4">Know More</Link>
                            </div>     
                        </div>
                </div>
                )
